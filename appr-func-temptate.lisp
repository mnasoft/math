...
yy(x@sub(1))=a@sub(1)*x@sub(1)@sup(2)*x@sub(2)@sup(2)+ a@sub(2)*x@sub(1)@sup(2)*x@sub(2)@sup(1)+ a@sub(3)*x@sub(1)@sup(1)*x@sub(2)@sup(2)+ a@sub(4)*x@sub(1)@sup(2)+ a@sub(5)*x@sub(2)@sup(2)+ a@sub(6)*x@sub(1)@sup(1)*x@sub(2)@sup(1)+ a@sub(7)*x@sub(1)@sup(1)+ a@sub(8)*x@sub(2)@sup(1)+ a@sub(9)
@end(code)")
