...
(defclass cubic ()
  ((a :accessor quadric-a :initform 1.0 :initarg :a :documentation "Коэффициент при степени 3.")
   (b :accessor quadric-b :initform 0.0 :initarg :b :documentation "Коэффициент при степени 2.")
   (c :accessor quadric-c :initform 1.0 :initarg :c :documentation "Коэффициент при степени 1.")
   (d :accessor quadric-c :initform 1.0 :initarg :c :documentation "Коэффициент при степени 0."))
...
(defclass quartic ()
  ((a :accessor quadric-a :initform 1.0 :initarg :a :documentation "Коэффициент при степени 4.")
   ...
   (c :accessor quadric-c :initform 1.0 :initarg :c :documentation "Коэффициент при степени 2.")
   (d :accessor quadric-c :initform 1.0 :initarg :c :documentation "Коэффициент при степени 1.")
   (e :accessor quadric-c :initform 1.0 :initarg :c :documentation "Коэффициент при степени 0."))
  (:documentation "Уравнение четвертой степени."))

(defgeneric roots ((eq quartic))
  
  )

(defgeneric roots ((eq cubic))
